...
Name_Bot = (redis:get(bot_id.."STORM:Redis:Name:Bot") or "ستورم")
------------------------------------------------------------------------------------------------------------
function var(value)  
...
CmdStart = '\n❍ اهلا بك عزيزي \n انا بوت اسمي '..(redis:get(bot_id.."STORM:Redis:Name:Bot") or "ستورم")..''..
...
if text == 'سورس ستورم' or text == 'ستورم' or text == 'تيست الكودد' then
local Text = [[
test
]]
keyboard = {} 
...
if text == 'قناه سورس ستورم' or text == 'قناه السورس' or text == 'قناة السورس' or text == 'توام اتتتلعالمي' or text == 'روح العتتالمي' then
local Text =[[
...
if text == (redis:get(bot_id.."STORM:Redis:Name:Bot") or "ستورم") then
Namebot = (redis:get(bot_id.."STORM:Redis:Name:Bot") or "ستورم")
local namebot = {
"يا روح "..Namebot.. " قول",
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'STORM.',url="t.me/Xx_b0dY_cV"}}, 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/" ..UserName_Dev.. "&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--- كليشه سورس ---
...
if text == 'الاوامر' or text == 'الاوامر ستورم' or text == 'الأوامر' then
if Admin(msg) then
local Text =[[
اهلا بك عزيزي في اوامر المجموعه❍
❰ 𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄 𝑺𝑻𝑶𝑹𝑴 ❱
اوامر المدراء
اوامر الحمايه
اوامر الادمني
اوامر التعطيل
...
{
{text = 'قناه سورس ستورم ', url = "https://t.me/Xx_b0dY_cV"}
},
{
{text = '𝐀𝐃𝐃 𝐓𝐇𝐄 𝐁𝐎𝐓 𝐓𝐎 𝐘𝐎𝐔𝐑 𝐆𝐑𝐎𝐔𝐏', url="https://t.me/"..User_Bot.."?startgroup=new"}
},
