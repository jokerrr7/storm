...
local text1 = redis:get(bot_id..'BLACK:new:sourse1') or '•━═━━𝑺𝑻𝑶𝑹𝑴━━═━•'
local text2 = redis:get(bot_id..'BLACK:new:sourse2') or '❍'
text = string.gsub(text,"•━═━━𝑺𝑻𝑶𝑹𝑴━━═━•",text1)
...
ᴄʜᴀɴᴇʟ ➳ [ 𝑺𝑻𝑶𝑹𝑴 𝑺𝑶𝑼𝑹𝑪𝑬](https://t.me/Xx_b0dY_cV)
]])
return false  
end
...
send(msg.chat_id_, msg.id_, t..'•━═━━𝑺𝑻𝑶𝑹𝑴━━═━•\nاضغط علي الاسم ليتم نسخه\n•━═━━𝑺𝑻𝑶𝑹𝑴━━═━•\n')
end
--__
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝑺𝑻𝑶𝑹𝑴 𝑺𝑶𝑼𝑹𝑪𝑬.',url="t.me/Xx_b0dY_cV"}}, 
